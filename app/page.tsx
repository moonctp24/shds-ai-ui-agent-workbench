      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="flex-[1.7] flex flex-col bg-white overflow-hidden">
          ...
          <div className="flex-1 flex items-center justify-center p-6 overflow-hidden">
            {activeTab === "PREVIEW" && (
              <div className="w-[453px] h-[877px] bg-[#1a1a1a] rounded-[40px] p-3 shadow-xl flex-shrink-0">
                <div className="w-full h-full bg-[#f5f5f5] rounded-[32px] relative overflow-hidden flex flex-col">
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[120px] h-[28px] bg-[#1a1a1a] rounded-b-2xl z-10" />
                  <div className="flex-1 overflow-y-auto pt-10 px-4 flex items-center justify-center">
            ...
            {activeTab === "CODE" && (
              <div className="w-full h-full bg-[#f8fafc] rounded-2xl p-8 overflow-y-auto">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  {/* <Code2 className="w-5 h-5 text-[#8b5cf6] stroke-[1.5]" /> */}

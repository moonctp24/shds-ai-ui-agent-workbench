...
from backend.app.graph.nodes.depth_map import depth_map_node
...
def build_graph():
    ...
    graph.add_node("depth_map", depth_map_node)
    ...
    graph.add_edge("file_scan", "depth_map")
    graph.add_edge("depth_map", "scenario_v1")
